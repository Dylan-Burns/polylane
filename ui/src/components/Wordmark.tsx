...
export function Wordmark() {
  return (
    <div className="flex items-center gap-2.5">
      ...
      {/* Lowercase JetBrains Mono, medium weight — the same treatment polylane.com gives its own
          wordmark, so Watchtower reads as part of the same product family. */}
      <span className="font-mono text-[15px] font-medium lowercase tracking-tight text-ink">watchtower</span>
    </div>
  );
}
